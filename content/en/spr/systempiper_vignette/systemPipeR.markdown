...
date: "Last update: 02 February, 2021" 
output:
...
```
    ...
    ##                                                                                                                                                                                                                                                                                                                                                                                    M1A 
    ## "tophat -p 4 -g 1 --segment-length 25 -i 30 -I 3000 -o /home/dcassol/danielac@ucr.edu/projects/SYSPipeWF_org/systemPipeR.github.io_docsy/content/en/spr/systempiper_vignette/results/SRR446027_1.fastq.gz.tophat /home/dcassol/danielac@ucr.edu/projects/SYSPipeWF_org/systemPipeR.github.io_docsy/content/en/spr/systempiper_vignette/data/tair10.fasta ./data/SRR446027_1.fastq.gz "
...
```
    ...
    ##                                                                                                                                                                           M1A 
    ## "/home/dcassol/danielac@ucr.edu/projects/SYSPipeWF_org/systemPipeR.github.io_docsy/content/en/spr/systempiper_vignette/results/SRR446027_1.fastq.gz.tophat/accepted_hits.bam"
...
<img src="/en/spr/systempiper_vignette/systemPipeR_files/figure-html/sample_tree_rlog-1.png" width="672" />
...
<img src="/en/spr/systempiper_vignette/systemPipeR_files/figure-html/edger_deg_counts-1.png" width="672" />
...
<img src="/en/spr/systempiper_vignette/systemPipeR_files/figure-html/deseq2_deg_counts-1.png" width="672" />
...
<img src="/en/spr/systempiper_vignette/systemPipeR_files/figure-html/vennplot-1.png" width="672" />
...
```
    ...
    ##  [3] dplyr_1.0.3                 magrittr_2.0.1             
    ##  [5] batchtools_0.9.15           ape_5.4-1                  
    ##  [7] ggplot2_3.3.3               systemPipeR_1.25.4         
    ...
    ##  [10] codetools_0.2-18         splines_4.0.3            cachem_1.0.1            
    ##  [13] geneplotter_1.68.0       knitr_1.31               jsonlite_1.7.2          
    ##  [16] annotate_1.68.0          GO.db_3.12.1             dbplyr_2.0.0            
    ...
    ##  [28] Matrix_1.2-18            fastmap_1.1.0            limma_3.46.0            
    ...
    ##  [40] rappdirs_0.3.2           V8_3.4.0                 Rcpp_1.0.6              
    ##  [43] vctrs_0.3.6              nlme_3.1-151             blogdown_1.1.7          
    ##  [46] rtracklayer_1.50.0       xfun_0.20                stringr_1.4.0           
    ##  [49] rvest_0.3.6              lifecycle_0.2.0          XML_3.99-0.5            
    ...
    ##  [61] curl_4.3                 memoise_2.0.0            biomaRt_2.46.2          
    ...
    ##  [94] crayon_1.3.4             BiocFileCache_1.14.0     rmarkdown_2.6           
