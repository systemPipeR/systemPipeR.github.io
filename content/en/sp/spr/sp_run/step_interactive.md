---
title: "Design and run a Workflow" 
...
<link id="plotwf_legend-1-attachment" rel="attachment" href="step_interactive_files/plotwf_legend/plotwf_legend.svg"/>
...
```
    ...
    ##  [1] systemPipeR_2.3.3           ShortRead_1.54.0           
    ...
    ##  [1] sass_0.4.1             jsonlite_1.8.0         bslib_0.3.1           
    ##  [4] assertthat_0.2.1       BiocManager_1.30.17    latticeExtra_0.6-29   
    ##  [7] GenomeInfoDbData_1.2.8 yaml_2.3.5             pillar_1.7.0          
    ## [10] lattice_0.20-45        glue_1.6.2             digest_0.6.29         
    ## [13] RColorBrewer_1.1-3     colorspace_2.0-3       htmltools_0.5.2       
    ## [16] Matrix_1.4-1           pkgconfig_2.0.3        bookdown_0.26         
    ## [19] zlibbioc_1.42.0        purrr_0.3.4            scales_1.2.0          
    ## [22] jpeg_0.1-9             tibble_3.1.7           generics_0.1.2        
    ## [25] ggplot2_3.3.6          ellipsis_0.3.2         cli_3.3.0             
    ## [28] magrittr_2.0.3         crayon_1.5.1           evaluate_0.15         
    ## [31] fansi_1.0.3            hwriter_1.3.2.1        blogdown_1.10         
    ## [34] tools_4.2.0            formatR_1.12           lifecycle_1.0.1       
    ## [37] stringr_1.4.0          munsell_0.5.0          DelayedArray_0.22.0   
    ## [40] compiler_4.2.0         jquerylib_0.1.4        rlang_1.0.2           
    ## [43] grid_4.2.0             RCurl_1.98-1.6         rstudioapi_0.13       
    ## [46] htmlwidgets_1.5.4      bitops_1.0-7           rmarkdown_2.14        
    ## [49] codetools_0.2-18       gtable_0.3.0           DBI_1.1.2             
    ## [52] R6_2.5.1               knitr_1.39             dplyr_1.0.9           
    ## [55] fastmap_1.1.0          utf8_1.2.2             stringi_1.7.6         
    ## [58] parallel_4.2.0         vctrs_0.4.1            png_0.1-7             
