...
```{r load_library, eval=FALSE, spr='r', spr.req='mandatory', spr.ses='local'}
...
```{r export_iris, eval=FALSE, spr='r', spr.req='mandatory', spr.ses='local'}
appendStep(sal) <- LineWise(code={
...
```{r gzip, eval=FALSE, spr='sysargs', spr.dep='export_iris', spr.req='mandatory', spr.ses='local'}
...
```{r gunzip, eval=FALSE, spr='sysargs', spr.dep='gzip', spr.req='mandatory', spr.ses='local'}
appendStep(sal) <- SYSargsList(
    targets = c("gzip"),
    dir_path="/home/runner/work/systemPipeR/systemPipeR/inst/extdata/cwl",
...
```{r stats, eval=FALSE, spr='r', spr.dep='gunzip', spr.req='optional', spr.ses='local'}
appendStep(sal) <- LineWise(code={
...
# Step6 echo
```{r echo, eval=FALSE, spr='sysargs', spr.req='mandatory', spr.ses='local'}
appendStep(sal) <- SYSargsList(
